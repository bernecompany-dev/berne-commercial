...
export const metadata: Metadata = metaFor({
  ...
  description:
    "Restaurants, hotels, laundromats, healthcare, grocery, schools, gyms, breweries, country clubs, multi-family — South Florida commercial repair across 10 verticals.",
  path: "/industries",
})
