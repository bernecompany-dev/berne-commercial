...
const LINKS: SocialLink[] = [
  // Google reviews — multiple GBP, pick the primary share-link
  { href: "https://g.co/kgs/6Y1RBpp", label: "Google reviews", icon: ICONS.google },
  // Yelp (parent residential primary)
    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
      <span
        className={`text-xs font-medium uppercase tracking-wider ${
          isLight ? "text-background/60" : "text-muted-foreground"
        }`}
      >
        {label}
      </span>
