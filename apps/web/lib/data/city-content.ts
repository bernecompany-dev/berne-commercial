...
const CITY_ENRICHMENTS: CityEnrichment[] = [
  ...
  // ──────────────────────────────────────────────────── Boynton Beach
  {
    ...
    paragraphs: [
      "Boynton Beach runs a quieter profile than the downtown West Palm dining core, but the commercial equipment load is real: the Federal Highway corridor's restaurants and waterfront dining around the Boynton Harbor Marina, the Ocean Avenue downtown district, the big-box and food-court cluster around the Boynton Beach Mall and Congress Avenue, and the Renaissance Commons mixed-use kitchens all run refrigeration, ice and cooking equipment on long South Florida duty cycles. Berne dispatches across all of it with the same $89 commercial service call, applied toward the approved repair.",
