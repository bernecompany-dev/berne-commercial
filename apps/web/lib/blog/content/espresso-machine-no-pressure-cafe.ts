...
export const espressoMachineNoPressure: Article = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "Berne Commercial Repair runs same-day dispatch for La Marzocco, Nuova Simonelli, Rancilio, Synesso, and Slayer espresso machines across Miami-Dade, Broward, and Palm Beach. $89 commercial service call, free if you go ahead with the repair. Call (754) 345-4515 or request service through our espresso machine repair page. For home-prosumer machines — Rocket, ECM, Lelit — bernerepair.com handles the residential side.",
      ],
    },
  ],
  internalLinks: [
