...
export const nsfInspectorFailedReachIn: Article = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "Berne Commercial Repair runs emergency same-day service for kitchens facing DBPR re-inspections across Miami-Dade, Broward, and Palm Beach. $89 commercial service call, applied to the approved repair, and a service invoice formatted for inspector review. Call (305) 520-7833 or request a tech through our reach-in cooler repair page. For home or office reach-ins — Sub-Zero, Viking, residential built-ins — bernerepair.com runs the residential side.",
      ],
    },
  ],
  internalLinks: [
