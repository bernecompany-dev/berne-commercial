...
export const commercialConvectionOvenEvenBake: Article = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "Berne Commercial Repair runs same-day dispatch for Vulcan, Blodgett, Garland, Wolf, and Imperial commercial convection ovens across Miami-Dade, Broward, and Palm Beach. $89 commercial service call — free when you approve the repair, paid only if you decline. Call (754) 345-4515 or request a tech through our commercial oven repair page. For residential built-in convection ovens — Wolf, Thermador, Miele — bernerepair.com runs the home side.",
      ],
    },
  ],
  internalLinks: [
