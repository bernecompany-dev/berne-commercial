...
export const commercialDishwasherLowPressure: Article = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "Berne Commercial Repair runs same-day dispatch for Hobart, Jackson, CMA, and Champion commercial dishwashers across Miami-Dade, Broward, and Palm Beach. $89 commercial service call — free if you approve the repair, paid only if you decline. Call (754) 345-4515 or request service through our commercial appliance repair page. For residential dishwasher service — Bosch, Miele, KitchenAid — our sister site bernerepair.com covers those calls.",
      ],
    },
  ],
  internalLinks: [
