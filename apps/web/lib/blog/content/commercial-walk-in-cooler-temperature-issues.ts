...
export const walkInCoolerTemperature: Article = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "Berne Commercial Repair runs same-day commercial dispatch across South Florida — $89 service call that is free when you approve the repair, with a refrigeration-specialist truck in your area most days. Call (754) 345-4515 or request service through our [walk-in cooler repair page](/services/walk-in-cooler-repair) or commercial refrigeration repair page. For residential refrigeration — Sub-Zero, Viking, or a basement reach-in at a property manager's residence — our sister site bernerepair.com covers that side.",
      ],
    },
  ],
  internalLinks: [
