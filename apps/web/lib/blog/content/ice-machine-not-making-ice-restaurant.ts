...
export const iceMachineNotMakingIce: Article = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "Berne Commercial Repair runs a $89 commercial service call across Miami-Dade, Broward, and Palm Beach — the diagnostic fee is waived if you approve the repair (you only pay it if you decline). Our trucks stock Hoshizaki KM, Manitowoc Indigo, and Scotsman Prodigy parts, plus 3M Cuno and Everpure filter cartridges. Call dispatch at (754) 345-4515 or request service through our [ice machine repair page](/services/ice-machine-repair).",
