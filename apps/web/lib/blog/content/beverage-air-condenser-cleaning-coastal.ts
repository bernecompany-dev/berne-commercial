...
export const beverageAirCondenserCleaning: Article = {
  slug: "beverage-air-condenser-cleaning-coastal",
  title:
  ...
  sections: [
    ...
    {
      heading: "2. The 90-day rule, and why most kitchens stretch it to a year",
      body: [
    ...
    {
      heading: "3. The actual cleaning procedure our techs run",
      body: [
    ...
    {
      heading: "4. What head pressure tells you about coil condition",
      body: [
    ...
    {
      heading: "5. Door gaskets, fan blades, and other quarterly checks",
      body: [
    ...
    {
      heading: "6. Service contracts vs per-call cleaning",
      body: [
    ...
    {
      heading: "7. Coil-coating retrofits and when to spec one",
      body: [
