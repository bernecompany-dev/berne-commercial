...
export const pepsiCokeFountainMachineService: Article = {
  slug: "pepsi-coke-fountain-machine-service-south-florida",
  title:
  ...
  sections: [
    ...
    {
      heading: "2. Flat soda — the carbonator, 80% of the time",
      body: [
    ...
    {
      heading: "3. Warm soda — refrigeration, and that is squarely ours",
      body: [
        "Fountain systems chill drinks one of three ways: an ice-cooled cold plate in the dispenser's ice bin, a remote recirculating chiller, or mechanical refrigeration in a drop-in unit. Warm product means the cold plate has no ice (an ice machine problem — see our [ice machine repair](/services/ice-machine-repair) page), the chiller's compressor or pump has failed, or the drop-in's refrigeration loop is down.",
    ...
    {
      heading: "4. The ice-cooled dispenser trap",
      body: [
    ...
    {
      heading: "6. Owned equipment: convenience stores, offices, self-serve",
      body: [
    ...
    {
      heading: "7. Sanitation: the part everyone skips",
      body: [
  ...
  internalLinks: [
    { label: "Soda & fountain machine repair", href: "/services/soda-machine-repair" },
    { label: "Ice machine repair", href: "/services/ice-machine-repair" },
    { label: "Soda machine repair in Hialeah Gardens", href: "/hialeah-gardens/soda-machine-repair" },
