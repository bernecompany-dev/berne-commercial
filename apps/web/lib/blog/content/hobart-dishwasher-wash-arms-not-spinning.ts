...
export const hobartDishwasherWashArms: Article = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "Berne Commercial Repair runs same-day dispatch for Hobart, Champion, Jackson, and CMA commercial dishwashers across Miami-Dade, Broward, and Palm Beach. $89 commercial service call, free with an approved repair. Call (754) 345-4515 or request a tech through our commercial appliance repair page. For home dishwashers — Bosch, Miele, KitchenAid built-ins — bernerepair.com handles the residential side.",
      ],
    },
  ],
  internalLinks: [
