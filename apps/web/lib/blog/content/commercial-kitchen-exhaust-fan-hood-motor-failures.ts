...
export const commercialKitchenExhaustFanHoodMotor: Article = {
  slug: "commercial-kitchen-exhaust-fan-hood-motor-failures",
  title:
  ...
  sections: [
    ...
    {
      heading: "2. The failure sequence: belt → bearing → motor",
      body: [
    ...
    {
      heading: "3. South Florida specifics: grease plus salt",
      body: [
    ...
    {
      heading: "4. The fire-marshal connection",
      body: [
    ...
    {
      heading: "6. Repair vs replace on rooftop fans",
      body: [
  ...
  internalLinks: [
    { label: "Commercial hood & exhaust repair", href: "/services/commercial-hood-repair" },
    { label: "Hood-vent & grease-trap fire-marshal guide", href: "/blog/hood-vent-grease-trap-fire-marshall" },
    { label: "Restaurant equipment repair", href: "/industries/restaurants" },
    { label: "Request dispatch", href: "/request-dispatch" },
  ],
  relatedSlugs: [
    "hood-vent-grease-trap-fire-marshall",
