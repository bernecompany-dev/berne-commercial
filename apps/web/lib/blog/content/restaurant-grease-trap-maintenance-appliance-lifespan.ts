...
export const greaseTrapApplianceLifespan: Article = {
  slug: "restaurant-grease-trap-maintenance-appliance-lifespan",
  title:
  ...
  sections: [
    {
      heading: "1. What the Miami-Dade FOG ordinance actually requires",
      body: [
    ...
    {
      heading: "2. The chain reaction when the trap is full",
      body: [
    ...
    {
      heading: "3. Dishwasher lifespan and pump wear",
      body: [
    ...
    {
      heading: "4. Ice machine drains and condensate management",
      body: [
    ...
    {
      heading: "5. Fryer, range, and hood — the grease side of the trap",
      body: [
    ...
    {
      heading: "6. The service-contract conversation",
      body: [
    ...
    {
      heading: "7. New construction and the right-sized trap",
      body: [
    ...
    {
      heading: "8. Real numbers from recent service tickets",
      body: [
    ...
    },
    {
      ...
      body: [
        "Berne Commercial Repair writes commercial service contracts that document grease-trap-related appliance stress on every visit and flag chronic drainage issues to the operator before they become equipment failures. We work across Miami-Dade, Broward, and Palm Beach. $89 commercial service call, free with an approved repair. Call (754) 345-4515 or reach us through our [commercial appliance repair page](/services/commercial-appliance-repair). For home plumbing and appliance work — disposals, dishwashers, washing machines — bernerepair.com handles the residential side.",
      ],
    },
  ],
  internalLinks: [
