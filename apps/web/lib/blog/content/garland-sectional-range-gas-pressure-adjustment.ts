...
export const garlandSectionalGasPressure: Article = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "Berne Commercial Repair installs and services Garland sectional ranges, charbroilers, salamanders, and convection ovens across Miami-Dade, Broward, and Palm Beach. Commissioning, manifold adjustment, orifice conversion, full diagnostic service. $89 commercial service call, free with an approved repair. Call (754) 345-4515 or request through our commercial range repair page.",
