...
export const commercialFryerThermostat: Article = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "Berne Commercial Repair runs same-day dispatch for Pitco, Frymaster, Vulcan, Imperial, and Wells commercial fryers across Miami-Dade, Broward, and Palm Beach. $89 commercial service call, free when you approve the repair. Call (754) 345-4515 or request service through our fryer repair page. For residential ranges with deep-fry features — Wolf, Viking, Thermador — our sister site bernerepair.com handles the home side.",
      ],
    },
  ],
  internalLinks: [
