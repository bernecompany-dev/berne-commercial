...
export const groceryDeliDisplayCaseHealthCallbacks: Article = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "Berne Commercial Repair services Hussmann, Hill Phoenix, Tyler, Kysor Warren, and Migali deli/meat/seafood cases across Miami-Dade, Broward, and Palm Beach. Self-contained and remote-rack service. EPA Section 608 certified. $89 commercial service call — free when you approve the repair, paid only if you decline. Call (754) 345-4515 or request through our commercial refrigeration repair page.",
