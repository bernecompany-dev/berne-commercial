...
export const combiOvenBuyingGuideSouthFlorida: Article = {
  slug: "combi-oven-buying-guide-south-florida",
  title:
  ...
  sections: [
    ...
    {
      heading: "2. The decision tree we use with clients",
      body: [
        ...
        "Then apply the constraints: footprint (no room → Unox compact lines, and the decision may be made for you), vendor consolidation (already on Welbilt ice and fryers → Convotherm), institutional procurement (domestic parts and warranty terms → Alto-Shaam), multi-unit fleet software (ConnectedCooking is the most mature → Rational). Our pairwise comparisons walk each matchup: [Rational vs Unox](/compare/rational-vs-unox), [Rational vs Convotherm](/compare/rational-vs-convotherm), and [Rational vs Alto-Shaam](/compare/rational-vs-alto-shaam).",
      ],
    },
    {
      heading: "3. Installed prices and 15-year ownership, side by side",
      body: [
    ...
    {
      heading: "6. Used and lease options",
      body: [
  ...
  internalLinks: [
    { label: "Rational vs other combi ovens (hub)", href: "/compare/rational-vs-combi" },
    { label: "Rational vs Unox", href: "/compare/rational-vs-unox" },
    { label: "Rational vs Convotherm", href: "/compare/rational-vs-convotherm" },
    { label: "Rational vs Alto-Shaam", href: "/compare/rational-vs-alto-shaam" },
